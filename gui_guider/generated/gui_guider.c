...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->init_screen_del = true;
    ui->connection_config_screen_del = true;
    ui->server_ip_screen_del = true;
    ui->stand_by_screen_del = true;
    ui->menu_screen_del = true;
    ui->cpu_performance_screen_del = true;
    ui->temperature_measure_screen_del = true;
    ui->accelerometer_measure_screen_del = true;
    ui->touch_measure_screen_del = true;
    ui->set_time_screen_del = true;
    ui->control_panel_screen_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_init_screen(ui);
    lv_screen_load(ui->init_screen);
}
