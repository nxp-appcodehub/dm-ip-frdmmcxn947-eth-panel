...
void setup_scr_menu_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->menu_screen, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->menu_screen, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(ui->menu_screen, &_Slide2_480x320, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->menu_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->menu_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->menu_screen_DateLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->menu_screen_HourLabel, 4, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->menu_screen_HourLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->menu_screen_MCUTempLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->menu_screen_BRDTempLabel, 264, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->menu_screen_BRDTempLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes menu_screen_label_5
    ui->menu_screen_label_5 = lv_label_create(ui->menu_screen);
    lv_label_set_text(ui->menu_screen_label_5, "MCU:");
    lv_label_set_long_mode(ui->menu_screen_label_5, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->menu_screen_label_5, 117, 5);
    lv_obj_set_size(ui->menu_screen_label_5, 46, 9);

    //Write style for menu_screen_label_5, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->menu_screen_label_5, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->menu_screen_label_5, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->menu_screen_label_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->menu_screen_label_5, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->menu_screen_label_5, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->menu_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes menu_screen_label_6
    ui->menu_screen_label_6 = lv_label_create(ui->menu_screen);
    lv_label_set_text(ui->menu_screen_label_6, "BRD:");
    lv_label_set_long_mode(ui->menu_screen_label_6, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->menu_screen_label_6, 229, 5);
    lv_obj_set_size(ui->menu_screen_label_6, 46, 9);

    //Write style for menu_screen_label_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->menu_screen_label_6, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->menu_screen_label_6, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->menu_screen_label_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->menu_screen_label_6, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->menu_screen_label_6, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->menu_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes menu_screen_label_7
    ui->menu_screen_label_7 = lv_label_create(ui->menu_screen);
    lv_label_set_text(ui->menu_screen_label_7, "Main Menu");
    lv_label_set_long_mode(ui->menu_screen_label_7, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->menu_screen_label_7, 140, 30);
    lv_obj_set_size(ui->menu_screen_label_7, 200, 20);

    //Write style for menu_screen_label_7, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->menu_screen_label_7, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->menu_screen_label_7, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->menu_screen_label_7, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->menu_screen_label_7, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->menu_screen_label_7, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->menu_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes menu_screen_PerformanceBTN
    ui->menu_screen_PerformanceBTN = lv_btn_create(ui->menu_screen);
    ...
    ui->menu_screen_TemperatureBTN = lv_btn_create(ui->menu_screen);
    ...
    ui->menu_screen_AccelBTN = lv_btn_create(ui->menu_screen);
    ...
    ui->menu_screen_TouchSenseBTN = lv_btn_create(ui->menu_screen);
    ...
    ui->menu_screen_TimeBTN = lv_btn_create(ui->menu_screen);
    ...
    ui->menu_screen_PanelBTN = lv_btn_create(ui->menu_screen);
    ...
    lv_obj_set_style_text_letter_space(ui->menu_screen_IPLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
