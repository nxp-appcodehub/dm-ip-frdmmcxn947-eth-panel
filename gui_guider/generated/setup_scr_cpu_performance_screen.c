...
void setup_scr_cpu_performance_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->cpu_performance_screen, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->cpu_performance_screen, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(ui->cpu_performance_screen, &_Slide2_480x320, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->cpu_performance_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->cpu_performance_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_DateLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->cpu_performance_screen_HourLabel, 4, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_HourLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_MCUTempLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->cpu_performance_screen_BRDTempLabel, 264, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_BRDTempLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->cpu_performance_screen_label_3, "MCU:");
    lv_label_set_long_mode(ui->cpu_performance_screen_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->cpu_performance_screen_label_3, 117, 5);
    lv_obj_set_size(ui->cpu_performance_screen_label_3, 46, 9);
    ...
    lv_obj_set_style_text_color(ui->cpu_performance_screen_label_3, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->cpu_performance_screen_label_3, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->cpu_performance_screen_label_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_3, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_2, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->cpu_performance_screen_label_1, "Performance");
    lv_label_set_long_mode(ui->cpu_performance_screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->cpu_performance_screen_label_1, 140, 30);
    lv_obj_set_size(ui->cpu_performance_screen_label_1, 200, 20);
    ...
    lv_obj_set_style_text_color(ui->cpu_performance_screen_label_1, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->cpu_performance_screen_label_1, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->cpu_performance_screen_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->cpu_performance_screen_MenuBTN = lv_btn_create(ui->cpu_performance_screen);
    ...
    lv_arc_set_bg_angles(ui->cpu_performance_screen_LvglArc, 0, 360);
    lv_arc_set_value(ui->cpu_performance_screen_LvglArc, 72);
    lv_arc_set_rotation(ui->cpu_performance_screen_LvglArc, 0);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_LvglArc, 0,  LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_LvglArc, 0, LV_STATE_DEFAULT);
    ...
    //Write style for cpu_performance_screen_LvglArc, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_LvglArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_LvglArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_LvglArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_LvglArc, 6, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_LvglArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_LvglArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_LvglArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_LvglArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_LvglArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_LvglArc, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_LvglArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_LvglArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_LvglArc, 6, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_LvglArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_LvglArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_LvglArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_LvglArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_LvglArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_LvglArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_LvglArc, Part: LV_PART_INDICATOR, State: LV_STATE_FOCUSED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_LvglArc, 55, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_LvglArc, 255, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_LvglArc, lv_color_hex(0x0068DF), LV_PART_INDICATOR|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_LvglArc, Part: LV_PART_INDICATOR, State: LV_STATE_DISABLED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_LvglArc, 55, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_LvglArc, 255, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_LvglArc, lv_color_hex(0x0068DF), LV_PART_INDICATOR|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_LvglArc, Part: LV_PART_KNOB, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_LvglArc, 0, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_LvglArc, 5, LV_PART_KNOB|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_LvglArc, Part: LV_PART_KNOB, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_LvglArc, 0, LV_PART_KNOB|LV_STATE_DISABLED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_LvglArc, 5, LV_PART_KNOB|LV_STATE_DISABLED);
    ...
    lv_arc_set_bg_angles(ui->cpu_performance_screen_EthernetArc, 0, 360);
    lv_arc_set_value(ui->cpu_performance_screen_EthernetArc, 72);
    lv_arc_set_rotation(ui->cpu_performance_screen_EthernetArc, 72);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_EthernetArc, 0,  LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_EthernetArc, 0, LV_STATE_DEFAULT);
    ...
    //Write style for cpu_performance_screen_EthernetArc, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_EthernetArc, 6, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_EthernetArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_EthernetArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_EthernetArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_EthernetArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_EthernetArc, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_EthernetArc, 6, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_EthernetArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_EthernetArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_EthernetArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_EthernetArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_EthernetArc, Part: LV_PART_INDICATOR, State: LV_STATE_FOCUSED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_EthernetArc, 55, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_EthernetArc, 255, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_EthernetArc, lv_color_hex(0x00A700), LV_PART_INDICATOR|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_EthernetArc, Part: LV_PART_INDICATOR, State: LV_STATE_DISABLED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_EthernetArc, 55, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_EthernetArc, 255, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_EthernetArc, lv_color_hex(0x00A700), LV_PART_INDICATOR|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_EthernetArc, Part: LV_PART_KNOB, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_EthernetArc, 5, LV_PART_KNOB|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_EthernetArc, Part: LV_PART_KNOB, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_EthernetArc, 0, LV_PART_KNOB|LV_STATE_DISABLED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_EthernetArc, 5, LV_PART_KNOB|LV_STATE_DISABLED);
    ...
    lv_arc_set_bg_angles(ui->cpu_performance_screen_SensorArc, 0, 360);
    lv_arc_set_value(ui->cpu_performance_screen_SensorArc, 72);
    lv_arc_set_rotation(ui->cpu_performance_screen_SensorArc, 216);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_SensorArc, 0,  LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_SensorArc, 0, LV_STATE_DEFAULT);
    ...
    //Write style for cpu_performance_screen_SensorArc, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_SensorArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_SensorArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_SensorArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_SensorArc, 6, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_SensorArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_SensorArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_SensorArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_SensorArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_SensorArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_SensorArc, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_SensorArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_SensorArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_SensorArc, 6, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_SensorArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_SensorArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_SensorArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_SensorArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_SensorArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_SensorArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_SensorArc, Part: LV_PART_INDICATOR, State: LV_STATE_FOCUSED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_SensorArc, 55, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_SensorArc, 255, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_SensorArc, lv_color_hex(0xEBE7DD), LV_PART_INDICATOR|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_SensorArc, Part: LV_PART_INDICATOR, State: LV_STATE_DISABLED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_SensorArc, 55, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_SensorArc, 255, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_SensorArc, lv_color_hex(0xEBE7DD), LV_PART_INDICATOR|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_SensorArc, Part: LV_PART_KNOB, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_SensorArc, 0, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_SensorArc, 5, LV_PART_KNOB|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_SensorArc, Part: LV_PART_KNOB, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_SensorArc, 0, LV_PART_KNOB|LV_STATE_DISABLED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_SensorArc, 5, LV_PART_KNOB|LV_STATE_DISABLED);
    ...
    lv_arc_set_bg_angles(ui->cpu_performance_screen_IdleArc1, 0, 360);
    lv_arc_set_value(ui->cpu_performance_screen_IdleArc1, 72);
    lv_arc_set_rotation(ui->cpu_performance_screen_IdleArc1, 144);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_IdleArc1, 0,  LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_IdleArc1, 0, LV_STATE_DEFAULT);
    ...
    //Write style for cpu_performance_screen_IdleArc1, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_IdleArc1, 6, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_IdleArc1, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_IdleArc1, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_IdleArc1, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_IdleArc1, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_MAIN|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_IdleArc1, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_IdleArc1, 6, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_IdleArc1, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_IdleArc1, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_IdleArc1, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_IdleArc1, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_IdleArc1, Part: LV_PART_INDICATOR, State: LV_STATE_FOCUSED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_IdleArc1, 55, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_IdleArc1, 255, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_IdleArc1, lv_color_hex(0xFF7400), LV_PART_INDICATOR|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_IdleArc1, Part: LV_PART_INDICATOR, State: LV_STATE_DISABLED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_IdleArc1, 55, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_IdleArc1, 255, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_IdleArc1, lv_color_hex(0xFF7400), LV_PART_INDICATOR|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_IdleArc1, Part: LV_PART_KNOB, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_IdleArc1, 5, LV_PART_KNOB|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_IdleArc1, Part: LV_PART_KNOB, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_IdleArc1, 0, LV_PART_KNOB|LV_STATE_DISABLED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_IdleArc1, 5, LV_PART_KNOB|LV_STATE_DISABLED);
    ...
    lv_arc_set_bg_angles(ui->cpu_performance_screen_MotorControlArc, 0, 360);
    ...
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_MotorControlArc, 0,  LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_MotorControlArc, 0, LV_STATE_DEFAULT);
    ...
    //Write style for cpu_performance_screen_MotorControlArc, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_MotorControlArc, 6, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_MotorControlArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_MotorControlArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_MotorControlArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_MotorControlArc, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_MAIN|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_MotorControlArc, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_MotorControlArc, 6, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_MotorControlArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_MotorControlArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_MotorControlArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_MotorControlArc, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_MotorControlArc, Part: LV_PART_INDICATOR, State: LV_STATE_FOCUSED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_MotorControlArc, 55, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_MotorControlArc, 255, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_MotorControlArc, lv_color_hex(0x0068DF), LV_PART_INDICATOR|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_MotorControlArc, Part: LV_PART_INDICATOR, State: LV_STATE_DISABLED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_MotorControlArc, 55, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_MotorControlArc, 255, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_MotorControlArc, lv_color_hex(0x0068DF), LV_PART_INDICATOR|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_MotorControlArc, Part: LV_PART_KNOB, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_MotorControlArc, 5, LV_PART_KNOB|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_MotorControlArc, Part: LV_PART_KNOB, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_MotorControlArc, 0, LV_PART_KNOB|LV_STATE_DISABLED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_MotorControlArc, 5, LV_PART_KNOB|LV_STATE_DISABLED);
    ...
    lv_arc_set_bg_angles(ui->cpu_performance_screen_IdleArc2, 0, 360);
    lv_arc_set_value(ui->cpu_performance_screen_IdleArc2, 360);
    lv_arc_set_rotation(ui->cpu_performance_screen_IdleArc2, 0);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_IdleArc2, 0,  LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_arc_rounded(ui->cpu_performance_screen_IdleArc2, 0, LV_STATE_DEFAULT);
    ...
    //Write style for cpu_performance_screen_IdleArc2, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_IdleArc2, 6, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_IdleArc2, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_IdleArc2, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_IdleArc2, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_IdleArc2, 20, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_MAIN|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_IdleArc2, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_border_width(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_radius(ui->cpu_performance_screen_IdleArc2, 6, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_top(ui->cpu_performance_screen_IdleArc2, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_bottom(ui->cpu_performance_screen_IdleArc2, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_left(ui->cpu_performance_screen_IdleArc2, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_pad_right(ui->cpu_performance_screen_IdleArc2, 20, LV_PART_MAIN|LV_STATE_DISABLED);
    lv_obj_set_style_shadow_width(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_MAIN|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_IdleArc2, Part: LV_PART_INDICATOR, State: LV_STATE_FOCUSED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_IdleArc2, 55, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_IdleArc2, 255, LV_PART_INDICATOR|LV_STATE_FOCUSED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_IdleArc2, lv_color_hex(0xFF7400), LV_PART_INDICATOR|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_IdleArc2, Part: LV_PART_INDICATOR, State: LV_STATE_DISABLED.
    lv_obj_set_style_arc_width(ui->cpu_performance_screen_IdleArc2, 55, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_opa(ui->cpu_performance_screen_IdleArc2, 255, LV_PART_INDICATOR|LV_STATE_DISABLED);
    lv_obj_set_style_arc_color(ui->cpu_performance_screen_IdleArc2, lv_color_hex(0xFF7400), LV_PART_INDICATOR|LV_STATE_DISABLED);
    ...
    //Write style for cpu_performance_screen_IdleArc2, Part: LV_PART_KNOB, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_IdleArc2, 5, LV_PART_KNOB|LV_STATE_FOCUSED);

    //Write style for cpu_performance_screen_IdleArc2, Part: LV_PART_KNOB, State: LV_STATE_DISABLED.
    lv_obj_set_style_bg_opa(ui->cpu_performance_screen_IdleArc2, 0, LV_PART_KNOB|LV_STATE_DISABLED);
    lv_obj_set_style_pad_all(ui->cpu_performance_screen_IdleArc2, 5, LV_PART_KNOB|LV_STATE_DISABLED);
    ...
    lv_obj_set_pos(ui->cpu_performance_screen_label_4, 210, 120);
    ...
    lv_obj_set_style_radius(ui->cpu_performance_screen_label_4, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_4, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->cpu_performance_screen_label_4, lv_color_hex(0xFF7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->cpu_performance_screen_label_5, 210, 160);
    ...
    lv_obj_set_style_radius(ui->cpu_performance_screen_label_5, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_5, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->cpu_performance_screen_label_5, lv_color_hex(0x0068DF), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->cpu_performance_screen_label_6, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_6, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->cpu_performance_screen_label_7, 210, 180);
    ...
    lv_obj_set_style_radius(ui->cpu_performance_screen_label_7, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_7, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->cpu_performance_screen_label_7, lv_color_hex(0xEBE7DD), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->cpu_performance_screen_label_8, 210, 200);
    ...
    lv_obj_set_style_radius(ui->cpu_performance_screen_label_8, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_8, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->cpu_performance_screen_label_8, lv_color_hex(0x0EAFE0), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_9, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->cpu_performance_screen_label_10, 70, 11);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_10, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_11, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->cpu_performance_screen_label_12, 60, 11);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_12, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->cpu_performance_screen_label_13, 60, 20);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_13, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->cpu_performance_screen_label_14, 71, 14);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_14, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->cpu_performance_screen_label_15, 71, 14);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_label_15, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes cpu_performance_screen_img_1
    ui->cpu_performance_screen_img_1 = lv_img_create(ui->cpu_performance_screen);
    lv_obj_add_flag(ui->cpu_performance_screen_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_pivot(ui->cpu_performance_screen_img_1, 50,50);
    lv_img_set_angle(ui->cpu_performance_screen_img_1, 0);
    lv_obj_set_pos(ui->cpu_performance_screen_img_1, 22, 62);
    lv_obj_set_size(ui->cpu_performance_screen_img_1, 441, 202);

    //Write style for cpu_performance_screen_img_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->cpu_performance_screen_img_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->cpu_performance_screen_img_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->cpu_performance_screen_img_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->cpu_performance_screen_img_1, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->cpu_performance_screen_IPLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
