...
void setup_scr_touch_measure_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->touch_measure_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui->touch_measure_screen, &_Slide2_RGB565A8_480x320, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_opa(ui->touch_measure_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->touch_measure_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes touch_measure_screen_label_1
    ui->touch_measure_screen_label_1 = lv_label_create(ui->touch_measure_screen);
    lv_obj_set_pos(ui->touch_measure_screen_label_1, 117, 5);
    lv_obj_set_size(ui->touch_measure_screen_label_1, 46, 9);
    lv_label_set_text(ui->touch_measure_screen_label_1, "MCU:");
    ...
    lv_obj_set_style_text_color(ui->touch_measure_screen_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->touch_measure_screen_label_1, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->touch_measure_screen_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->touch_measure_screen_label_3, 135, 30);
    lv_obj_set_size(ui->touch_measure_screen_label_3, 206, 23);
    lv_label_set_text(ui->touch_measure_screen_label_3, "Touch Sense");
    ...
    lv_obj_set_style_text_color(ui->touch_measure_screen_label_3, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->touch_measure_screen_label_3, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->touch_measure_screen_label_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_label_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes touch_measure_screen_label_4
    ui->touch_measure_screen_label_4 = lv_label_create(ui->touch_measure_screen);
    lv_obj_set_pos(ui->touch_measure_screen_label_4, 190, 147);
    lv_obj_set_size(ui->touch_measure_screen_label_4, 100, 15);
    lv_label_set_text(ui->touch_measure_screen_label_4, "Electrode");
    lv_label_set_long_mode(ui->touch_measure_screen_label_4, LV_LABEL_LONG_WRAP);

    //Write style for touch_measure_screen_label_4, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->touch_measure_screen_label_4, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->touch_measure_screen_label_4, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->touch_measure_screen_label_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->touch_measure_screen_label_4, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->touch_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes touch_measure_screen_MenuBTN
    ui->touch_measure_screen_MenuBTN = lv_button_create(ui->touch_measure_screen);
    ...
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_MCUTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->touch_measure_screen_BRDTempLabel, 265, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_BRDTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->touch_measure_screen_HourLabel, 3, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_HourLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_DateLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_IPLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->touch_measure_screen_ElectrodeLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_width(ui->touch_measure_screen_TouchArc, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_rounded(ui->touch_measure_screen_TouchArc, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->touch_measure_screen_TouchArc, 6, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->touch_measure_screen_TouchArc, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->touch_measure_screen_TouchArc, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->touch_measure_screen_TouchArc, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->touch_measure_screen_TouchArc, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_width(ui->touch_measure_screen_TouchArc, 12, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_rounded(ui->touch_measure_screen_TouchArc, true, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_all(ui->touch_measure_screen_TouchArc, 0, LV_PART_KNOB|LV_STATE_DEFAULT);

    //Write codes touch_measure_screen_img_2
    ui->touch_measure_screen_img_2 = lv_image_create(ui->touch_measure_screen);
    lv_obj_set_pos(ui->touch_measure_screen_img_2, 54, 68);
    lv_obj_set_size(ui->touch_measure_screen_img_2, 375, 183);
    lv_obj_add_flag(ui->touch_measure_screen_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_pivot(ui->touch_measure_screen_img_2, 50,50);
    lv_image_set_rotation(ui->touch_measure_screen_img_2, 0);

    //Write style for touch_measure_screen_img_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->touch_measure_screen_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->touch_measure_screen_img_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
