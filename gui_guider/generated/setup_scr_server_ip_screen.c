...
void setup_scr_server_ip_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_image_src(ui->server_ip_screen, &_Slide2_RGB565A8_480x320, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_opa(ui->server_ip_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->server_ip_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes server_ip_screen_label_1
    ui->server_ip_screen_label_1 = lv_label_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_label_1, 117, 5);
    lv_obj_set_size(ui->server_ip_screen_label_1, 46, 9);
    lv_label_set_text(ui->server_ip_screen_label_1, "MCU:");
    ...
    lv_obj_set_style_text_color(ui->server_ip_screen_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->server_ip_screen_label_1, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->server_ip_screen_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes server_ip_screen_label_2
    ui->server_ip_screen_label_2 = lv_label_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_label_2, 229, 5);
    lv_obj_set_size(ui->server_ip_screen_label_2, 46, 9);
    lv_label_set_text(ui->server_ip_screen_label_2, "BRD:");
    lv_label_set_long_mode(ui->server_ip_screen_label_2, LV_LABEL_LONG_WRAP);

    //Write style for server_ip_screen_label_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->server_ip_screen_label_2, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->server_ip_screen_label_2, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->server_ip_screen_label_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->server_ip_screen_label_2, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->server_ip_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes server_ip_screen_label_3
    ui->server_ip_screen_label_3 = lv_label_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_label_3, 135, 30);
    lv_obj_set_size(ui->server_ip_screen_label_3, 206, 23);
    lv_label_set_text(ui->server_ip_screen_label_3, "Server IP");
    ...
    lv_obj_set_style_text_color(ui->server_ip_screen_label_3, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->server_ip_screen_label_3, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->server_ip_screen_label_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_label_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->server_ip_screen_label_7, 50, 150);
    lv_obj_set_size(ui->server_ip_screen_label_7, 215, 30);
    ...
    lv_obj_set_style_radius(ui->server_ip_screen_label_7, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_label_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->server_ip_screen_label_5, 100, 158);
    lv_obj_set_size(ui->server_ip_screen_label_5, 5, 15);
    lv_label_set_text(ui->server_ip_screen_label_5, ".");
    ...
    lv_obj_set_style_text_color(ui->server_ip_screen_label_5, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->server_ip_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->server_ip_screen_label_5, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->server_ip_screen_label_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->server_ip_screen_label_5, lv_color_hex(0x848484), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->server_ip_screen_label_5, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->server_ip_screen_label_6, 155, 158);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->server_ip_screen_label_8, 64, 85);
    lv_obj_set_size(ui->server_ip_screen_label_8, 140, 35);
    lv_label_set_text(ui->server_ip_screen_label_8, "Select and write mask");
    ...
    lv_obj_set_style_text_color(ui->server_ip_screen_label_8, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->server_ip_screen_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->server_ip_screen_label_8, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->server_ip_screen_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->server_ip_screen_label_9, 210, 158);
    lv_obj_set_size(ui->server_ip_screen_label_9, 5, 15);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_label_9, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_MCUTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->server_ip_screen_BRDTempLabel, 265, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_BRDTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_HourLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->server_ip_screen_DateLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->server_ip_screen_SaveIPBTN = lv_button_create(ui->server_ip_screen);
    ...
    ui->server_ip_screen_IPCnf1 = lv_button_create(ui->server_ip_screen);
    ...
    ui->server_ip_screen_IPCnf2 = lv_button_create(ui->server_ip_screen);
    ...
    ui->server_ip_screen_IPCnf3 = lv_button_create(ui->server_ip_screen);
    ...
    ui->server_ip_screen_IPCnf4 = lv_button_create(ui->server_ip_screen);
    ...
    ui->server_ip_screen_N1Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N1Btn, 278, 68);
    ...
    ui->server_ip_screen_N2Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N2Btn, 328, 68);
    ...
    ui->server_ip_screen_N3Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N3Btn, 378, 68);
    ...
    ui->server_ip_screen_N4Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N4Btn, 278, 118);
    ...
    ui->server_ip_screen_N5Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N5Btn, 328, 118);
    ...
    ui->server_ip_screen_N6Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N6Btn, 378, 118);
    ...
    ui->server_ip_screen_N7Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N7Btn, 278, 168);
    ...
    ui->server_ip_screen_N8Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N8Btn, 328, 168);
    ...
    ui->server_ip_screen_N9Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N9Btn, 378, 168);
    ...
    ui->server_ip_screen_N0Btn = lv_button_create(ui->server_ip_screen);
    lv_obj_set_pos(ui->server_ip_screen_N0Btn, 328, 218);
