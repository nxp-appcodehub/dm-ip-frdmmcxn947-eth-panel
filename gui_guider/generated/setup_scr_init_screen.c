...
void setup_scr_init_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->init_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui->init_screen, &_Slide2_RGB565A8_480x320, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_opa(ui->init_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->init_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->init_screen_HourLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes init_screen_label_1
    ui->init_screen_label_1 = lv_label_create(ui->init_screen);
    lv_obj_set_pos(ui->init_screen_label_1, 117, 5);
    lv_obj_set_size(ui->init_screen_label_1, 46, 9);
    lv_label_set_text(ui->init_screen_label_1, "MCU:");
    lv_label_set_long_mode(ui->init_screen_label_1, LV_LABEL_LONG_WRAP);

    //Write style for init_screen_label_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->init_screen_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->init_screen_label_1, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->init_screen_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->init_screen_label_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->init_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->init_screen_MCUTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->init_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->init_screen_BRDTempLabel, 265, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->init_screen_BRDTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->init_screen_DateLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->init_screen_label_3, 135, 30);
    lv_obj_set_size(ui->init_screen_label_3, 206, 23);
    lv_label_set_text(ui->init_screen_label_3, "Mode Select");
    ...
    lv_obj_set_style_text_color(ui->init_screen_label_3, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->init_screen_label_3, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->init_screen_label_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->init_screen_label_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->init_screen_master_btn = lv_button_create(ui->init_screen);
    ...
    lv_obj_set_style_bg_color(ui->init_screen_master_btn, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->init_screen_interface_btn = lv_button_create(ui->init_screen);
    ...
    lv_obj_set_style_bg_color(ui->init_screen_interface_btn, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(ui->init_screen_ip_manual_check_box, lv_color_hex(0x2195f6), LV_PART_INDICATOR|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_bg_color(ui->init_screen_ip_manual_check_box, lv_color_hex(0x2195f6), LV_PART_INDICATOR|LV_STATE_CHECKED);
