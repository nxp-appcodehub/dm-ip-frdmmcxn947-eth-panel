...
void setup_scr_control_panel_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->control_panel_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui->control_panel_screen, &_Slide2_RGB565A8_480x320, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_opa(ui->control_panel_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->control_panel_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes control_panel_screen_label_1
    ui->control_panel_screen_label_1 = lv_label_create(ui->control_panel_screen);
    lv_obj_set_pos(ui->control_panel_screen_label_1, 117, 5);
    lv_obj_set_size(ui->control_panel_screen_label_1, 46, 9);
    lv_label_set_text(ui->control_panel_screen_label_1, "MCU:");
    ...
    lv_obj_set_style_text_color(ui->control_panel_screen_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->control_panel_screen_label_1, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->control_panel_screen_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->control_panel_screen_label_3, 135, 30);
    lv_obj_set_size(ui->control_panel_screen_label_3, 206, 23);
    lv_label_set_text(ui->control_panel_screen_label_3, "Control Panel");
    ...
    lv_obj_set_style_text_color(ui->control_panel_screen_label_3, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->control_panel_screen_label_3, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->control_panel_screen_label_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_label_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->control_panel_screen_MenuBTN = lv_button_create(ui->control_panel_screen);
    ...
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_MCUTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->control_panel_screen_BRDTempLabel, 265, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_BRDTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->control_panel_screen_HourLabel, 3, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_HourLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_DateLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_IPLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->control_panel_screen_RPMLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->control_panel_screen_RPMChart, 380, 128);
    ...
    lv_obj_set_style_border_width(ui->control_panel_screen_RPMChart, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->control_panel_screen_RPMChart, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->control_panel_screen_RPMChart, lv_color_hex(0xe8e8e8), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->control_panel_screen_RPMChart, LV_BORDER_SIDE_BOTTOM | LV_BORDER_SIDE_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->control_panel_screen_RPMSlider, 100, 232);
    ...
    lv_obj_set_style_radius(ui->control_panel_screen_RPMSlider, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->control_panel_screen_RPMSlider, 8, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->control_panel_screen_RPMSlider, 8, LV_PART_KNOB|LV_STATE_DEFAULT);
