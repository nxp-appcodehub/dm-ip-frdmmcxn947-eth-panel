...
void setup_scr_set_time_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->set_time_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->set_time_screen, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->set_time_screen, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(ui->set_time_screen, &_Slide2_480x320, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->set_time_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->set_time_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->set_time_screen_DateLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->set_time_screen_HourLabel, 4, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->set_time_screen_HourLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->set_time_screen_MCUTempLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->set_time_screen_BRDTempLabel, 264, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->set_time_screen_BRDTempLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->set_time_screen_label_3, "MCU:");
    lv_label_set_long_mode(ui->set_time_screen_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->set_time_screen_label_3, 117, 5);
    lv_obj_set_size(ui->set_time_screen_label_3, 46, 9);
    ...
    lv_obj_set_style_text_color(ui->set_time_screen_label_3, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->set_time_screen_label_3, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->set_time_screen_label_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->set_time_screen_label_3, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->set_time_screen_label_2, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->set_time_screen_label_1, "Config Time");
    lv_label_set_long_mode(ui->set_time_screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->set_time_screen_label_1, 140, 30);
    lv_obj_set_size(ui->set_time_screen_label_1, 200, 20);
    ...
    lv_obj_set_style_text_color(ui->set_time_screen_label_1, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->set_time_screen_label_1, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->set_time_screen_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->set_time_screen_label_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->set_time_screen_MenuBTN = lv_btn_create(ui->set_time_screen);
    ...
    lv_obj_set_style_border_opa(ui->set_time_screen_HourRoller, 190, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->set_time_screen_HourRoller, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->set_time_screen_HourRoller, 200, LV_PART_SELECTED|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->set_time_screen_HourRoller, lv_color_hex(0x9a9a9a), LV_PART_SELECTED|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->set_time_screen_HourRoller, &lv_font_montserratMedium_20, LV_PART_SELECTED|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->set_time_screen_label_5, "Hours");
    lv_label_set_long_mode(ui->set_time_screen_label_5, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->set_time_screen_label_5, 118, 81);
    ...
    lv_obj_set_style_text_letter_space(ui->set_time_screen_label_5, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes set_time_screen_label_6
    ui->set_time_screen_label_6 = lv_label_create(ui->set_time_screen);
    lv_label_set_text(ui->set_time_screen_label_6, "Minutes");
    lv_label_set_long_mode(ui->set_time_screen_label_6, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->set_time_screen_label_6, 258, 81);
    lv_obj_set_size(ui->set_time_screen_label_6, 105, 10);

    //Write style for set_time_screen_label_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->set_time_screen_label_6, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->set_time_screen_label_6, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->set_time_screen_label_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->set_time_screen_label_6, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->set_time_screen_label_6, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->set_time_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes set_time_screen_SetBtn
    ui->set_time_screen_SetBtn = lv_btn_create(ui->set_time_screen);
    ...
    lv_obj_set_style_text_font(ui->set_time_screen_MinutesTensRoller, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_opa(ui->set_time_screen_MinutesTensRoller, 190, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->set_time_screen_MinutesTensRoller, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->set_time_screen_MinutesTensRoller, 200, LV_PART_SELECTED|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->set_time_screen_MinutesTensRoller, lv_color_hex(0x9a9a9a), LV_PART_SELECTED|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->set_time_screen_MinutesTensRoller, &lv_font_montserratMedium_20, LV_PART_SELECTED|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->set_time_screen_MinutesUnitsRoller, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_opa(ui->set_time_screen_MinutesUnitsRoller, 190, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->set_time_screen_MinutesUnitsRoller, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->set_time_screen_MinutesUnitsRoller, 200, LV_PART_SELECTED|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->set_time_screen_MinutesUnitsRoller, lv_color_hex(0x9a9a9a), LV_PART_SELECTED|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->set_time_screen_MinutesUnitsRoller, &lv_font_montserratMedium_20, LV_PART_SELECTED|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_opa(ui->set_time_screen_MeridianRoller, 190, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->set_time_screen_MeridianRoller, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->set_time_screen_MeridianRoller, 200, LV_PART_SELECTED|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->set_time_screen_MeridianRoller, lv_color_hex(0x9a9a9a), LV_PART_SELECTED|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->set_time_screen_MeridianRoller, &lv_font_montserratMedium_20, LV_PART_SELECTED|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->set_time_screen_IPLabel, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
