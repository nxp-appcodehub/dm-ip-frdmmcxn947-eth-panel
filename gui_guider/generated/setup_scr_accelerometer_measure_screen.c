...
void setup_scr_accelerometer_measure_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->accelerometer_measure_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui->accelerometer_measure_screen, &_Slide2_RGB565A8_480x320, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_opa(ui->accelerometer_measure_screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->accelerometer_measure_screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_label_1, 117, 5);
    lv_obj_set_size(ui->accelerometer_measure_screen_label_1, 46, 9);
    lv_label_set_text(ui->accelerometer_measure_screen_label_1, "MCU:");
    ...
    lv_obj_set_style_text_color(ui->accelerometer_measure_screen_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->accelerometer_measure_screen_label_1, &lv_font_montserratMedium_11, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->accelerometer_measure_screen_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_label_3, 135, 30);
    lv_obj_set_size(ui->accelerometer_measure_screen_label_3, 206, 23);
    lv_label_set_text(ui->accelerometer_measure_screen_label_3, "Accelerometer");
    ...
    lv_obj_set_style_text_color(ui->accelerometer_measure_screen_label_3, lv_color_hex(0xff7400), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->accelerometer_measure_screen_label_3, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->accelerometer_measure_screen_label_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_label_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_label_4, 60, 105);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_label_5, 60, 155);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_label_6, 60, 205);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->accelerometer_measure_screen_MenuBTN = lv_button_create(ui->accelerometer_measure_screen);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_MCUTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_BRDTempLabel, 265, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_BRDTempLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_HourLabel, 3, 5);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_HourLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_DateLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_IPLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_AccelZBar, 230, 190);
    lv_obj_set_size(ui->accelerometer_measure_screen_AccelZBar, 170, 40);
    lv_obj_set_style_anim_duration(ui->accelerometer_measure_screen_AccelZBar, 1000, 0);
    ...
    lv_obj_set_style_anim_duration(ui->accelerometer_measure_screen_AccelYBar, 1000, 0);
    ...
    lv_obj_set_style_anim_duration(ui->accelerometer_measure_screen_AccelXBar, 1000, 0);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_AccelXLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_AccelYLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->accelerometer_measure_screen_AccelZLabel, 123, 205);
    ...
    lv_obj_set_style_text_letter_space(ui->accelerometer_measure_screen_AccelZLabel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
